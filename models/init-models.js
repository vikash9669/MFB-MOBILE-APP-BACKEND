...
function initModels(sequelize) {
  ...
  var store_users_shipping_address = _store_users_shipping_address(
    sequelize,
    DataTypes
  );

  store_orders_log.belongsTo(store_orders, {
    as: "order",
    foreignKey: "order_id",
  });
  store_orders.hasMany(store_orders_log, {
    as: "store_orders_logs",
    foreignKey: "order_id",
  });
  store_orders_log.belongsTo(store_users, {
    as: "user",
    foreignKey: "user_id",
  });
  store_users.hasMany(store_orders_log, {
    as: "store_orders_logs",
    foreignKey: "user_id",
  });
  store_users_business.belongsTo(store_users, {
    as: "user",
    foreignKey: "user_id",
  });
  store_users.hasMany(store_users_business, {

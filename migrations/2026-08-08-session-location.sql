...
ALTER TABLE store_delivery_sessions
  ADD COLUMN IF NOT EXISTS start_lat DECIMAL(10,7) NULL AFTER duration_min,
  ADD COLUMN IF NOT EXISTS start_lng DECIMAL(10,7) NULL AFTER start_lat,
  ADD COLUMN IF NOT EXISTS end_lat   DECIMAL(10,7) NULL AFTER start_lng,
  ADD COLUMN IF NOT EXISTS end_lng   DECIMAL(10,7) NULL AFTER end_lat;

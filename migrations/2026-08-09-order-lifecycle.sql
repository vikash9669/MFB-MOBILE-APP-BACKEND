...
ALTER TABLE `store_orders`
  ...
  ADD COLUMN `order_accepted_time`  DATETIME     NULL,
  -- Minutes the vendor promised for preparation, captured at accept time.
  ADD COLUMN `order_prep_minutes`   SMALLINT     NULL,
  ...
  ADD COLUMN `order_cancel_reason`  VARCHAR(255) NULL,
...
CREATE UNIQUE INDEX `merchant_refund_id_idx`
